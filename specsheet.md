...
| DR_PERMS          | JSON      | NOT NULL                       | list of json of doctors and associated perms           |                                      |  
| DR_PERMS_REQUESTS | JSON      | NOT NULL                       | list of json of doctors and associated perm requests   |                                      |    
```    
```{=latex}    
\end{tiny}    
```    
